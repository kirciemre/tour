    ...
    <div class="content-wrapper">
        <aside>
            <div class="profile-img-wrapper">
                <img src="assets/images/emre.png" alt="profile">
            </div>
            <h1 class="profile-name">Emre KIRCI</h1>
            ...
            <nav class="social-links">
                ...
                <a href="{{route('login')}}" class="social-link"><i class="fab fa-user-cog"></i></a>
            </nav>
            <div class="widget">
                <h5 class="widget-title">personal information</h5>
                <div class="widget-content">
                    <p>BIRTHDAY : 26 June 1990</p>
                    <p>WEBSITE : www.emrekirci.com</p>
                    <p>MAIL : emre@emrekirci.com</p>
